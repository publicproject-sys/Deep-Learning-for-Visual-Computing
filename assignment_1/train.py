...
from dlvc.models.class_model import DeepClassifier, DeepClassifierWithDropout
...
def train(args):
    ...
    # Load datasets with correct file paths (adjust to local paths)
    ...
    # Load resnet model without pretrained weights, add dropout if enabled
    if args.dropout:
        print("Dropout regularization is enabled")
        model = DeepClassifierWithDropout(torchvision.models.resnet18())
    else:
        model = DeepClassifier(torchvision.models.resnet18())
    ...
    model_save_dir = Path("/caa/Student/dlvc/dlvc11711533/assignment_1/saved_models/resnet18_dropout")
    #model_save_dir = Path("saved_models/resnet18_dropout")
