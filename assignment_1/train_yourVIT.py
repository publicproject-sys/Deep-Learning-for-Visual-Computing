...
#from dlvc.models.vit_backup import ViT
...
def train(args):
    ...
    model_save_dir = Path("/caa/Student/dlvc/dlvc11711533/assignment_1/saved_models/yourvit")
...
if __name__ == "__main__":
    ...
    args.add_argument('--dropout', default = 0, type = int,
                      help = 'Dropout rate for regularization')
    args.add_argument('--emb_dropout', default = 0, type = int,
                      help = 'Embedding dropout rate for regularization')
